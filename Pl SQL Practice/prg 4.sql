...
update class set meet = '10:30' where cname="Data Structures";
update class set meet = '12:30' where cname="Database Systems";
update class set meet = '12:00' where cname="Operating System Design";
update class set meet = '03:00' where cname="Archaeology of the Incas";
update class set meet = '01:00' where cname="Aviation Accident Investigation";
update class set meet = '10:30' where cname="Air Quality Engineering";
update class set meet = '03:00' where cname="Introductory Latin";
update class set meet = '02:00' where cname="American Political Parties";
update class set meet = '06:30' where cname="Social Cognition";
update class set meet = '03:00' where cname="Perception";
update class set meet = '02:00' where cname="Multivariate Analysis";
update class set meet = '01:00' where cname="Patent Law";
update class set meet = '11:00' where cname="Urban Economics";
update class set meet = '12:30' where cname="Organic Chemistry";
update class set meet = '10:00' where cname="Marketing Research";
update class set meet = '04:00' where cname="Seminar in American Art";
update class set meet = '08:00' where cname="Orbital Mechanics";
update class set meet = '12:30' where cname="Dairy Herd Management";
update class set meet = '09:30' where cname="Communication Networks";
update class set meet = '12:30' where cname="Optical Electronics";
update class set meet = '08:30' where cname="Intoduction to Math";
